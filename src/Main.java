...
public class Main {
    ...
    public static ArrayList<Integer> feistelCipher(
        ArrayList<Integer> list, ArrayList<ArrayList<Integer>> keys, char mode) {
    ...
    public static ArrayList<Integer> DES(ArrayList<Integer> binaryCode, char mode, String skey) {
        ArrayList<Integer> result = new ArrayList<>();
        ...
        while (!binaryCode.isEmpty()) {
            ...
            //теперь делаем начальную перестановку
            workBloc = initialPermutation(workBloc);

            workBloc = feistelCipher(workBloc, keys48b, mode);

            workBloc = finalPermutation(workBloc);
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Integer> result = DES(binaryCode, 'e', skey);
        System.out.println();
        System.out.println("result = " + convertToCharStr(result));


        ArrayList<Integer> result2 = DES(result, 'd', skey);
        System.out.println();
